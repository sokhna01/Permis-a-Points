...
<main>
    ...
    <div id="fumerVolant" class="modal">
        <div class="modal-content">
            ...
            <p class="gras">Fumer en conduisant est autorisé à condition que la cigarette ne gêne pas la conduite. Si le conducteur quitte des yeux la route pour jeter ses mégots dans le cendrier, cela peut être dangereux si sa vigilance et sa concentration sont diminués. L'application de l'interdiction de fumer au volant et la verbalisation de l'usage de la cigarette reste à la libre appréciation des forces de l'ordre.</p>
            <p><span class="gras">Type :</span> Contravention de classe 1 </p>
            <p><span class="gras">Amende :</span> 5000Frcs </p>
            <br />
            <p><span class="gras">Minorée :</span> 33000Frcs</p>
            <p><span class="gras">Majorée : </span>10000Frcs</p>
            <p><span class="gras">Maxima :</span> 15000Frcs </p>
            <br />
            <p><span class="gras">Points: </span> 1 </p>
            <p>Il faut savoir que l'interdiction de fumer au volant s'applique dans trois cas : lorsque le conducteur n'est pas en état et en position d'exécuter commodément et sans délai toutes les manœuvres liées à la conduite, en présence d'une personne mineure et dans les lieux à usage collectif comme les véhicules de fonction.
            </p>
        </div>
    </div>
</main>